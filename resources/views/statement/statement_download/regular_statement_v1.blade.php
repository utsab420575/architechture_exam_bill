...
@foreach($teachers as  $teacher)
    ...
    <table class="header_table " style=" table-layout: fixed;">
        ...
        <tr>
            ...
            <td colspan="1" style="text-align: left;padding-left: 40px;">
                <span style="font-weight: bold">Regular</span>
            </td>
            <td colspan="1" style="text-align: right;padding-left: 20px;">
    ...
    <h3>List of Examination Committee/Moderation Committee Members (@ min 1500/- per member)</h3>
    {{-- Body Table --}}
