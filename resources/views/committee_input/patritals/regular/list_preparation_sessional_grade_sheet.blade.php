                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-4">
                            <div class="form-group">
                                ...
                                <input type="number"  name="sessional_grade_sheet_rate" value="{{$sessional_grade_sheet_per_subject_rate??50}}" step="any" class="form-control" placeholder="Enter per student per subject rate" required>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                        </div>
