                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-4">
                            <div class="form-group">
                                ...
                                <input type="number"  name="scrutinize_sessional_grade_sheet_rate" value="{{$scrunizing_sessional_grade_sheet_per_subject_rate??12}}" step="any" class="form-control" placeholder="Enter per student per subject rate" required>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                        </div>
                                        ...
                                        <div class="card-body card-list-of-scrutinizers-sessional-grade-sheet">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @endphp
                                                    <label for="scrutinizing_theory_grade_sheet_no_of_students">Number of Students</label>
