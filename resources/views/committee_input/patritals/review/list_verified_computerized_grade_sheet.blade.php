...
@endpush
<form id="form-list-of-verified-computerized-result" action="{{ route('committee.input.review.verified.computerized.grade.sheet.store') }}" method="POST">
    @csrf
            ...
            <section class="card card-featured card-featured-primary">
                <header class="card-header d-flex align-items-center">
                    <h2 class="card-title">
                        ...
                        List of Teachers Verified Computerized Grade Sheets & GPA List (@**/- per student)
                    </h2>
                </header>
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch(form.action, {
                            ...
                            .then(data => {
                                ...
                                submitBtn.textContent = 'Update Verified Computerized Grade Sheet Committee';
