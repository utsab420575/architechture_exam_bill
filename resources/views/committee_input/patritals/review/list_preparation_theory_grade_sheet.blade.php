                    ...
                    <div class="row mb-2">
                        <div class="col-md-4 mb-4">
                            <div class="form-group">
                                ...
                                <input type="number"  name="theory_grade_sheet_rate" value="{{$theory_grade_sheet_per_subject_rate??60}}" step="any" class="form-control" placeholder="Enter per student per subject rate" required>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                        </div>
                                        ...
                                        <div class="card-body card-list-of-prepares-theory-grade-sheet">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    @endphp
                                                    <label for="prepares_theory_grade_sheet_no_of_students">No of script</label>
