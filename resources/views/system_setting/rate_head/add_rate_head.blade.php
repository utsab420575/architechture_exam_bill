            ...
            <div class="col-lg-10 col-xl-8">
                <div class="card">
                    <header class="card-header">
                        <h2 class="card-title">New Rate Head Form</h2>
                    </header>
                    <div class="card-body">
                        <form method="POST" action="{{ route('rate_head.store') }}" class="p-3">
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="head" name="head"
                                           placeholder="e.g. Moderation Committee" value="{{ old('head') }}" required>
                                    @error('head')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="order_no" name="order_no"
                                           placeholder="e.g. 1, 2, 8.a" value="{{ old('order_no') }}" required>
                                    @error('order_no')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="sub_head" name="sub_head"
                                           placeholder="Enter sub head (optional)" value="{{ old('sub_head') }}">
                                    @error('sub_head')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="dist_type" name="dist_type"
                                           placeholder="e.g. individual, equal, shared" value="{{ old('dist_type') }}" required>
                                    @error('dist_type')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="form-control" name="marge_with" id="marge_with">
                                        ...
                                        @foreach($parent_rate_heads as $p_head)
                                            <option value="{{ $p_head->id }}" {{ old('marge_with') == $p_head->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mb-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_min" name="enable_min" value="1" {{ old('enable_min') ? 'checked' : '' }}>
                                        <label class="form-check-label font-weight-semibold" for="enable_min">Enable Minimum Rate Limit</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="enable_max" name="enable_max" value="1" {{ old('enable_max') ? 'checked' : '' }}>
                                        <label class="form-check-label font-weight-semibold" for="enable_max">Enable Maximum Rate Limit</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_course" name="is_course" value="1" {{ old('is_course') ? 'checked' : '' }}>
                                        <label class="form-check-label font-weight-semibold" for="is_course">Is Course Dependent?</label>
                                    </div>
                                </div>
                                <div class="col-md-6 mb-2">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_student_count" name="is_student_count" value="1" {{ old('is_student_count') ? 'checked' : '' }}>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa-solid fa-save me-1"></i> Save Rate Head
                                    </button>
