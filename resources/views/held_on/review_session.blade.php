            ...
            <div class="col">
                <section class="card">
                    <header class="card-header">
                        <h2 class="card-title">Enter Exam Held On Dates — All Active Review Sessions</h2>
                    </header>
                    <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="text-center text-muted">No active review sessions found.</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
