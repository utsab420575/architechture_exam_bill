...
use App\Services\SpecialSessionFormDataService;
...
// 6) Count for your Blade
        ...
        $preloadedData = SpecialSessionFormDataService::getPreloadedFormData($session_info, $exam_type->id);

        return view('committee_input.special_form.special_session_form', array_merge([
            'sid' => $sid,
