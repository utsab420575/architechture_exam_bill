...
use App\Services\RegularSessionFormDataService;
...
class CommitteeInputController extends Controller
{
    ...
    public function regularSessionForm(Request $request)
    {
        ...
        $preloadedData = RegularSessionFormDataService::getPreloadedFormData($session_info, $exam_type->id);

        return view('committee_input.regular_form.regular_session_form', array_merge([
            'sid' => $sid,
